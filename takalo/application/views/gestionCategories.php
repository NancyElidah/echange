                ...
                <nav class="navbar navbar-expand">
                    <nav class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
							<div class="dashboard_bar" style="color: orange;">
					...
					<li class="dropdown header-profile">
						<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							<div class="header-info ms-3">
								<span class="font-w600 "><b>Madama</b></span>
								<small class="text-end font-w400">madama@gmail.com</small>
							</div>
						</a>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">  
                                ...
                                <button type="button" class="btn btn-outline-secondary"> Ajout des categories </button> 
                                </div>
                            </div>
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>PPN</td>
                                                <td><button type="button" class="btn btn-outline-secondary">Modifier</button></td>
                                                <td><button type="button" class="btn btn-outline-success">Supprimer</button></td>
                                            </tr>
                                            <tr>
