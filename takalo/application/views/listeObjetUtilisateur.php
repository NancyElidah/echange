...
<!-- Mirrored from dompet.dexignlab.com/xhtml/table-datatable-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Sep 2022 10:36:31 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <nav class="navbar navbar-expand">
                    <nav class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
							<div class="dashboard_bar" style="color: orange; font-size: 30px; text-align: center;">
                              Listes des objets 
                            </div>
                        </div>
            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
					<li class="dropdown header-profile">
						<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							<div class="header-info ms-3">
								<span class="font-w600 ">Hi,<b>Madama</b></span>
								<small class="text-end font-w400">Liantsoa@gmail.com</small>
							</div>
						</a>
                    ...
                    <li>
                        ...
                        <span class="nav-text">Jaona</span>
                    </a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-025-dashboard"></i>
							<span class="nav-text">Mirlin</span>
                        </a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-041-graph"></i>
							<span class="nav-text">Nancy</span>
						</a>
                    </li>
                </ul>
			</div>
												...
												<div class="card-body">
													<div class="new-arrival-product">
														<div class="new-arrivals-img-contnent">
															<img class="img-fluid" src="<?php echo base_url("/assets/images/product/1.jpg"); ?>" alt="">
														</div>
														<div class="new-arrival-content text-center mt-3">
															<h4><a href="ecom-product-detail.html">Toyota</a></h4>
															<h6>Entana mbola manitra be</h6>
															<span class="price">120000 Ar</span> 
															<p>
										...
										<div class="col-xl-3 col-lg-6 col-sm-6">
											<div class="card">
												<div class="card-body">
													<div class="new-arrival-product">
														<div class="new-arrivals-img-contnent">
															<img class="img-fluid" src="<?php echo base_url("/assets/images/product/2.jpg"); ?>"  alt="">
														</div>
														<div class="new-arrival-content text-center mt-3">
															<h4><a href="ecom-product-detail.html">Peugeot</a></h4>
															<h6>Entana mbola manitra be</h6>
															<span class="price">120000 Ar</span>
															<p>
																<button type="button" class="btn btn-outline-secondary">Modifier</button>
										...
										<div class="col-xl-3 col-lg-6 col-sm-6">
											<div class="card">
												<div class="card-body">
													<div class="new-arrival-product">
														<div class="new-arrivals-img-contnent">
															<img class="img-fluid" src="<?php echo base_url("/assets/images/product/3.jpg"); ?>"  alt="">
														</div>
														<div class="new-arrival-content text-center mt-3">
															<h4><a href="ecom-product-detail.html">bougie</a></h4>
															<h6>Entana mbola manitra be</h6>
															<span class="price">120000 Ar</span>
															<p>
																<button type="button" class="btn btn-outline-secondary">Modifier</button>
										...
										<div class="col-xl-3 col-lg-6 col-sm-6">
											<div class="card">
												<div class="card-body">
													<div class="new-arrival-product">
														<div class="new-arrivals-img-contnent">
															<img class="img-fluid" src="<?php echo base_url("/assets/images/product/4.jpg"); ?>"  alt="">
														</div>
														<div class="new-arrival-content text-center mt-3">
															<h4><a href="ecom-product-detail.html">aspirateur</a></h4>
															<h6>Entana mbola manitra be</h6>
															<span class="price">120000 Ar</span>
															<p>
																<button type="button" class="btn btn-outline-secondary">Modifier</button>
										...
										<div class="col-xl-3 col-lg-6 col-sm-6">
											<div class="card">
												<div class="card-body">
													<div class="new-arrival-product">
														<div class="new-arrivals-img-contnent">
															<img class="img-fluid" src="<?php echo base_url("/assets/images/product/5.jpg"); ?>"  alt="">
														</div>
														<div class="new-arrival-content text-center mt-3">
															<h4><a href="ecom-product-detail.html">sakay</a></h4>
															<h6>Entana mbola manitra be</h6>
															<span class="price">120000 Ar</span>
															<p>
																<button type="button" class="btn btn-outline-secondary">Modifier</button>
										...
										<div class="col-xl-3 col-lg-6 col-sm-6">
											<div class="card">
												<div class="card-body">
													<div class="new-arrival-product">
														<div class="new-arrivals-img-contnent">
															<img class="img-fluid" src="<?php echo base_url("/assets/images/product/6.jpg"); ?>"  alt="">
														</div>
														<div class="new-arrival-content text-center mt-3">
															<h4><a href="ecom-product-detail.html">machine a laver</a></h4>
															<h6>Entana mbola manitra be</h6>
															<span class="price">120000 Ar</span>
															<p>
																<button type="button" class="btn btn-outline-secondary">Modifier</button>
										...
										<div class="col-xl-3 col-lg-6 col-sm-6">
											<div class="card">
												<div class="card-body">
													<div class="new-arrival-product">
														<div class="new-arrivals-img-contnent">
															<img class="img-fluid" src="<?php echo base_url("/assets/images/product/7.jpg"); ?>"  alt="">
														</div>
														<div class="new-arrival-content text-center mt-3">
															<h4><a href="ecom-product-detail.html">aspirateur</a></h4>
															<h6>Entana mbola manitra be</h6>
...
<!-- Mirrored from dompet.dexignlab.com/xhtml/table-datatable-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Sep 2022 10:36:35 GMT -->
</html>